...
while(liczba!=zagadka):
    ...
    if liczba == zagadka:
        print("Sukces, w {} probach zgadłeś wylosowaną liczbę, którą jest{}".format(proba, zagadka))
    else:
        if liczba > zagadka:
        ...
        if proba >=  maksymalna_proba:        
            print("Niestety nie udało się w {1} probach. Wylosowano liczbe {0}.".format(zagadka, proba))
            break